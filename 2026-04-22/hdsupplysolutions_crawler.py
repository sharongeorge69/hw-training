...
class Crawler:
    ...
    def get_product_sitemaps(self, max_retries=3):
        ...
        for attempt in range(max_retries):
            try:
                response = requests.get(self.main_sitemap, headers=self.headers, timeout=30)
    ...
    def start(self):
        ...
        logger.info(f"Total sitemaps found: {len(product_sitemaps)}")
