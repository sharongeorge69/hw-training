...
# For the list, we reuse the same headers but MUST change the 'Referer' to match the list page
# otherwise the server might reject the request.
    ...
    while True:
        ...
        try:
            ...
            for card in cards:
                ...
                # 5. Get Phone Numbers (using icon logic)
                ...
                # Fallback if the first path failed
