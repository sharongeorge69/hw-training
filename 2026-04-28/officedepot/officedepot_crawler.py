...
class Crawler:
        ...
        for attempt in range(max_retries):
            try:
                ...
                if response.status_code == 200:
                    ...
                    product_sitemaps = [s for s in sitemaps if "product_sitemap" in s]
                    
                    if not product_sitemaps:
                        logger.warning("No product sitemaps found in index. Returning found sitemaps.")
                        return sitemaps
    ...
    def parse_item(self, sitemap_url):
        ...
        try:
            ...
            # For OfficeDepot, product URLs typically contain /products/
    ...
    def start(self):
        max_retries = 3
        logger.info("Starting OfficeDepot crawler...")
